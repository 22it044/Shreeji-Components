        ...
        <section className="py-24 relative overflow-hidden bg-[#11182c]">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-20">
              ...
              >
                <span className="bg-amber-500/20 text-amber-500 text-xs font-medium px-5 py-2 rounded-full border border-amber-500/30 shadow-glow-sm hover:shadow-glow-amber transition-all duration-300 uppercase tracking-wider">
                  Our Promise
                </span>
              </motion.div>
              ...
              >
                Quality <span className="text-amber-500 relative inline-block">
                  Commitments
                  <motion.span
                    initial={{ width: 0 }}
                    ...
                    className="absolute -bottom-1 left-0 h-0.5 bg-amber-500/50 rounded-full"
                  ></motion.span>
                </span>
              </motion.h2>
              ...
              <motion.div
                ...
                className="h-1 mb-8 mx-auto bg-gradient-to-r from-amber-400 to-amber-600 rounded-full"
              ></motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {qualityCommitments.map((commitment, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-b from-white/8 to-white/3 backdrop-blur-sm p-8 rounded-xl border border-amber-500/20 shadow-elegant hover:shadow-glow-amber hover:border-amber-500/40 hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden"
                >
                  {/* Premium decorative elements */}
                  ...
                  <div className="absolute top-0 right-0 w-24 h-24 bg-amber-500/5 rounded-full -mr-12 -mt-12 blur-2xl group-hover:bg-amber-500/10 transition-colors duration-500"></div>

                  {/* Subtle background glow on hover */}
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 to-amber-500/0 group-hover:from-amber-500/7 group-hover:to-amber-600/4 transition-colors duration-500 rounded-xl"></div>

                  

                  <h3 className="text-xl font-semibold mb-4 text-white group-hover:text-amber-500 transition-colors duration-300 relative inline-block">
                    {commitment.title}
                    <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-amber-500/0 group-hover:w-full group-hover:bg-amber-500/30 transition-all duration-500 rounded-full"></div>
                  </h3>

                  <div className="w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-600 mb-5 rounded-full group-hover:w-20 transition-all duration-500"></div>

                  <p className="text-white/70 mb-4 leading-relaxed group-hover:text-white/90 transition-colors duration-300">{commitment.description}</p>

                </motion.div>
              ))}
            </div>

            {/* A Grade Vendor Award Section */}
            <div className="mt-20 bg-gradient-to-b from-white/8 to-white/3 backdrop-blur-sm p-10 rounded-xl border border-amber-500/20 shadow-elegant hover:shadow-glow-amber transition-all duration-500 group relative overflow-hidden">
              {/* Premium decorative elements */}
              <div className="absolute -top-6 -right-6 w-12 h-12 border-t-2 border-r-2 border-amber-500/30 rounded-tr-xl z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 border-b-2 border-l-2 border-amber-500/30 rounded-bl-xl z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="absolute top-0 right-0 w-36 h-36 bg-amber-500/5 rounded-full -mr-12 -mt-12 blur-3xl group-hover:bg-amber-500/10 transition-colors duration-500"></div>
              ...
              >
                <motion.span
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="inline-block px-5 py-2 bg-amber-500/10 rounded-full border border-amber-500/30 shadow-glow-sm mb-4 text-amber-500 text-sm font-medium tracking-wider uppercase"
                >
                  Recognition
                </motion.span>

                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Consistent <span className="text-amber-500 relative inline-block">
                  'A' grade
                  <motion.span
                    initial={{ width: 0 }}
                    whileInView={{ width: "100%" }}
                    ...
                    className="absolute -bottom-1 left-0 h-0.5 bg-amber-500/50 rounded-full"
                  ></motion.span>
                </span> vendor award from MNCs since 20 years</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <motion.div
                  ...
                  className="bg-gradient-to-b from-white/8 to-white/3 p-6 rounded-lg border border-amber-500/10 text-center hover:border-amber-500/20 transition-all duration-300 group/item relative overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 to-amber-500/0 group-hover/item:from-amber-500/2 group-hover/item:to-amber-600/2 transition-colors duration-300 rounded-lg"></div>

                  <div className="w-14 h-14 mx-auto bg-gradient-to-br from-amber-500/20 to-amber-700/20 rounded-full flex items-center justify-center mb-4 border border-amber-500/30 group-hover/item:border-amber-500/40 transition-all duration-300 relative">
                    <Settings className="w-6 h-6 text-amber-500 transition-colors duration-300" />
                  </div>

                  <h4 className="text-white font-medium mb-2 transition-colors duration-300 relative inline-block">
                ...
                >
                  ...
                  <div className="w-14 h-14 mx-auto bg-gradient-to-br from-amber-500/20 to-amber-700/20 rounded-full flex items-center justify-center mb-4 border border-amber-500/30 group-hover/item:border-amber-500/40 transition-all duration-300 relative">
                    <Shield className="w-6 h-6 text-amber-500 transition-colors duration-300" />
                  </div>
                ...
                >
                  ...
                  <div className="w-14 h-14 mx-auto bg-gradient-to-br from-amber-500/20 to-amber-700/20 rounded-full flex items-center justify-center mb-4 border border-amber-500/30 group-hover/item:border-amber-500/40 transition-all duration-300 relative">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-amber-500 transition-colors duration-300">
                ...
                >
                  ...
                  <div className="w-14 h-14 mx-auto bg-gradient-to-br from-amber-500/20 to-amber-700/20 rounded-full flex items-center justify-center mb-4 border border-amber-500/30 group-hover/item:border-amber-500/40 transition-all duration-300 relative">
                    <Award className="w-6 h-6 text-amber-500 transition-colors duration-300" />
                  </div>
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.15 }}
              transition={{ duration: 0.8 }}
              className="mt-20 bg-gradient-to-b from-white/8 to-white/3 backdrop-blur-sm p-10 rounded-xl border border-amber-500/20 shadow-elegant hover:shadow-glow-amber hover:border-amber-500/30 transition-all duration-500 group relative overflow-hidden text-center"
            >
              {/* Premium decorative elements */}
              <div className="absolute -top-6 -right-6 w-12 h-12 border-t-2 border-r-2 border-amber-500/30 rounded-tr-xl z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="absolute -bottom-6 -left-6 w-12 h-12 border-b-2 border-l-2 border-amber-500/30 rounded-bl-xl z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <motion.span
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="inline-block px-5 py-2 bg-amber-500/10 rounded-full border border-amber-500/30 shadow-glow-sm mb-8 text-amber-500 text-sm font-medium tracking-wider uppercase"
              >
                Make in India
              </motion.span>

              <p className="text-white/90 text-lg mb-6 leading-relaxed group-hover:text-white transition-colors duration-300">
                Shreeji Components is committed to give high quality engineering products and is working in all aspects to fulfill the customer satisfaction for achieving excellence in its manufacturing.
              </p>

              <p className="text-white/90 text-lg mb-6 leading-relaxed group-hover:text-white transition-colors duration-300">
                Shreeji Components is proud to contribute to India's 🇮🇳 growth story with keeping in mind 'Make in India' goal of our country is trying to achieve.
              </p>

              <p className="text-white/90 text-lg mb-8 leading-relaxed group-hover:text-white transition-colors duration-300">
                Together let's take our nation to new heights in growth, prosperity and excellence.
              </p>

              <div className="inline-block bg-amber-500/20 text-amber-500 text-lg font-medium px-8 py-3 rounded-full border border-amber-500/30 shadow-glow-sm hover:shadow-glow-amber hover:bg-amber-500/30 transition-all duration-300">
                Jai Hind 🇮🇳
              </div>
            </motion.div>
          </div>
